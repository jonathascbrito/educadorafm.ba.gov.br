<template>
  <div>
    <div class="d-flex align-items-center mb-3 mt-0">
      ...
      <div slot="control" class="d-xl-none d-xxl-none d-sm-flex">
        <button class="view-more-left glide--ltr" role="button" style="background-color: #383838" data-glide-dir="<" @click="handleButtonClickHighLightPrev">
          <i class="bi bi-chevron-left" aria-hidden="true" style="color: white"></i>
        </button>
        <button class="view-more-right glide--rtl" role="button" style="background-color: #383838" data-glide-dir=">" @click="handleButtonClickHighLightNext">
          <i class="bi bi-chevron-right" aria-hidden="true" style="color: white"></i>
        </button>
      </div>
    </div>
    <vue-glide :options="options" class="row list mb-1 p-0 gx-0">
      <template slot="control">
        <button ref="buttonHighLightPrev" style="background-color: #383838" data-glide-dir="<" class="d-none">
          <i class="fa fa-angle-left" aria-hidden="true" style="color: white"></i>
        </button>
        <button ref="buttonHighLightNext" style="background-color: #383838" data-glide-dir=">" class="d-none">
          <i class="fa fa-angle-right" aria-hidden="true" style="color: white"></i>
        </button>
      </template>
      <vue-glide-slide v-for="edition in editions" :key="edition.id" class="p-0">
        <div class="card">
          <a href="">
          ...
          <div class="card-body p-0 mt-0" v-if="edition.program_id !== 'Marca-Acervo'">
            <router-link
          ...
          <div class="card-body p-0 mt-0" v-if="edition.program_id === 'Marca-Acervo'">
            <router-link
              :to="{ name: 'acervo', params: { id_program: edition.program_id, id_edition: edition.id }}" style="text-decoration: none">
              <h5 class="card-line mb-0 pb-0">
                <TruncateTextHelperComponent :max-caracteres="65" :texto-completo="`${edition.thin_line}`" style="font-family: 'Poppins light', sans-serif; font-weight: 400; font-size: 13px"/>
              </h5>
...
export default {
  ...
  methods: {
    ...
    //  }
    // }
    handleButtonClickHighLightPrev () {
      this.$refs.buttonHighLightPrev.click()
    },
    handleButtonClickHighLightNext () {
      this.$refs.buttonHighLightNext.click()
    },
