<template>
  <div>
    ...
    <vue-glide :options="options" class="row list p-0 gx-0">
      ...
      <vue-glide-slide v-for="edition in editions" :key='"authors"+edition.id' class="p-0" style="margin-bottom: 0px">
        <div class="card">
          <a href="">
...
export default {
  name: 'SliserSearchAuthorsComponent',
  components: {
    [Glide.name]: Glide,
    [GlideSlide.name]: GlideSlide,
    TruncateTextHelperComponent
  },
  props: ['editions', 'options', 'mp3Play', 'idPlay', 'pauseMp3', 'busca'],
  data () {
    return {
