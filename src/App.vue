<template>
  <div id="app">
    <div class="root">
      ...
      <NavBarComponent :isPlayingAoVivo="isPlayingAoVivo" :programName="programName" :programInicio="programInicio" :programFim="programFim" :playAoVivo="playAoVivo" :pauseAudio="pauseAudio"/>
      <TopBarComponent :searchQuery="searchQuery" :playMP3="playMp3" :idPlay="idPlay" :pauseMP3="pauseMp3" :sharing="sharing" @search="handleSearch" :url="url"/>
      <transition name="fade" mode="out-in">
        <router-view ref="childComponentRef" :playMP3="playMp3" :idPlay="idPlay" :pauseMP3="pauseMp3" :sharing="sharing" :seachQuery="searchQuery" :copyLink="copyLink" :url="url" @updateSearch="updateSearch" @search="handleSearch" @emitFunctionPlayMp3="emitFunctionPlayMp3" @emitFunctionPauseMp3="pauseMp3"/>
      </transition>
      <PlayerComponent :programName="programName" :isPlayingTimeAoVivo="isPlayingTimeAoVivo" :redoTime="redoTime" :undoTime="undoTime" :offCanvasOn="offCanvasOn" @playerRef="setAudioRef" :playMusic="playMusic" :pauseAudioT="pauseAudio" :audioSrc="audioSrc" :isPlaying="isPlaying" :isPlayingAoVivo="isPlayingAoVivo" :sharing="sharing" :copyLink="copyLink" :url="url" :ingestInfoShared="ingestInfoShared"/>
      <FooterComponent />
    </div>
  </div>
    ...
    playMp3 (valor, id, img, name_edition, name_program, program_id, url_share=null, thin_line=null, description=null) {
      ...
      if(urlSplit[1] === 'selo') {
        this.sharing = {
          ...
          title: `Escute ${program_id} que faz parte do Selo Educadora FM Independente. `,
          description: `*Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios`,
          quote: 'É sua! É da Bahia',
        ...
        this.sharing = {
          url: 'https://educadorafm.ba.gov.br'+url_share,
          title: `Acervo Educadora FM 107.5 apresenta ${thin_line} |`,
          description: `- Escute programas especiais com conteúdos exclusivos do Acervo da Rádio Educadora FM fundada em 1978. *Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios`,
          quote: 'É sua! É da Bahia',
        ...
        this.sharing = {
          ...
          description: `- Escute os Especiais das Seis com os vencedores das Edições do Festival de Música Educadora FM. *Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios`,
          quote: 'É sua! É da Bahia',
          hashtags: 'EducadoraFM,FestivalDeMusicaEducadoraFM,musica',
          twitterUser: 'educadorafmba'
        }
      } else if(urlSplit[1] === 'mixtape') {
        this.sharing = {
          url: 'http://educadorafm.ba.gov.br'+url_share,
          title: `Escute comigo ${name} do Mixtape da Educadora FM 107.5 - ${thin_line}`,
          description: `*Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios`,
          quote: 'É sua! É da Bahia',
          hashtags: 'EducadoraFM,musica,RadioEducadoraBA,EducadoraFMPlay',
          twitterUser: 'educadorafmba'
        ...
        this.sharing = {
          url: 'http://educadorafm.ba.gov.br'+url_share,
          title: `Escute comigo o programa ${program} da Educadora FM - ${thin_line}`,
          description: `*Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios`,
          quote: 'É sua! É da Bahia',
          hashtags: 'EducadoraFM,musica,RadioEducadoraBA,EducadoraFMPlay',
          twitterUser: 'educadorafmba'
