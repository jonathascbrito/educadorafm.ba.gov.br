<template>
  <div id="main" class="main d-flex flex-column">
    ...
    <div class="main-container">
      ...
      <div class="d-flex align-items-center mb-2">
        <div>
          <h2 class="title mb-2" v-if="generos.generosEditions">Gênero Aqui</h2>
          <h2 class="title mb-2" v-if="generos.length === 0">Nenhum resultado para Gênero Musical</h2>
          <span class="subtitle">
          </span>
        </div>
      </div>

      <SliderSearchComponent v-if="editionsLoaded === true && generos.generoEditions.length !== 0" :options="glideOptions" :editions="generos.generoEditions" :mp3Play="playMP3Search" :idPlay="idPlaySearch" :pauseMp3="pauseMP3Search" :busca="query" :key="generoKey"/>
      <SliderSearchArtistsComponent v-if="editionsLoaded === true && artists.artistsEditions.length !== 0" :options="glideOptions" :editions="artists.artistsEditions" :mp3Play="playMP3Search" :idPlay="idPlaySearch" :pauseMp3="pauseMP3Search" :busca="query" :key="artistKey"/>
      <SliderSearchAuthorsComponent v-if="editionsLoaded === true && authors.authorsEditions.length !== 0" :options="glideOptions" :editions="authors.authorsEditions" :mp3Play="playMP3Search" :idPlay="idPlaySearch" :pauseMp3="pauseMP3Search" :busca="query" :key="authorKey"/>
      <SliderSearchMusicsComponent v-if="editionsLoaded === true && musics.musicsEditions.length !== 0" :options="glideOptions" :editions="musics.musicsEditions" :mp3Play="playMP3Search" :idPlay="idPlaySearch" :pauseMp3="pauseMP3Search" :busca="query" :key="musicKey"/>
      <!--
