        ...
        <div class="d-flex col-8 d-none d-sm-block">
          <div class="container">
            <div class="col-9" style="color: white; font-family: 'Poppins', sans-serif">
              <!-- <h3 v-html="'Edição: '+ formattedDate(edition.edition)" class="mb-4" style="'Poppins', sans-serif; font-weight: 400; line-height: 25px; font-size: 21px"></h3> -->
              <h3 class="mb-4" style="'Poppins', sans-serif; font-weight: 400; line-height: 25px; font-size: 21px">{{edition.thin_line}}</h3>
