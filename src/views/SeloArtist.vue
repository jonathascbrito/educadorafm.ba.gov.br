          ...
          <div class="container ml-5">
            <vue-glide :options="glideOptions" class="row list p-0 gx-0 d-block d-sm-none">
                ...
                <div class="card" style="background-color: #383838; max-width: 219px">
                  ...
                  <div class="stamp-program" v-if=" artist.id != idPlay "
                       @click="playMP3(
                           'https://ingest.educadorafm.ba.gov.br/'+artist.url,
                            artist.id,
                            'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.picture.path,
                            artist.music,
                            'Selo Educadora FM',
                            artist.name,
                            `/selo/artista/${artist.id}`
                  ...
                  <div class="card-body p-0">
                    <a style="text-decoration: none">
                      ...
                      <p class="card-text ml-1" style="font-family: 'Poppins light', sans-serif; font-size: 13px">Música: {{ artist.music }} <br/>
              ...
              <vue-glide-slide class="p-0" style="margin-bottom: 0px">
                <div class="card" style="background-color: #383838; max-width: 219px">
                  <a :href="'/selo/'">
                    <img :src="'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.especial_seis.picture.path"
                         class="card-img-top mb-1" style="max-width: 219px"/>
                  </a>
                  <div class="stamp">
                    <!-- <img class="" src="https://educadorafm.ba.gov.br/logo.png" width="100%"> -->
                  ...
                  <div class="stamp-program" v-if=" artist.especial_seis.id != idPlay "
                       @click="playMP3(
                         'https://ingest.educadorafm.ba.gov.br/'+artist.especial_seis.mp3_upload.url,
                               artist.especial_seis.id,
                               'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.picture.path,
                                artist.trabalho,
                                'Especial das Seis',
                                artist.name,
                  ...
                  <div class="stamp-program" v-if="artist.especial_seis.id == idPlay " @click="pauseMP3(artist.id)">
                    <img class="img-fluid"
                         :src="`https://ingest.educadorafm.ba.gov.br/img/stamp-programs/pause/21.svg`">
                  </div>
                  <div class="card-body p-0">
                    <a style="text-decoration: none;">
                      <h5 class="card-title ml-1" style="font-family: 'Poppins light', sans-serif; font-size: 13px">{{ artist.especial_seis.thin_line }}</h5>
                    </a>
                  </div>
                </div>
              </vue-glide-slide>
              <vue-glide-slide class="p-0" style="margin-bottom: 0px">
                <div class="card" style="background-color: #383838; max-width: 219px">
                  <a :href="'/selo/'">
                    <img :src="'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.multicultura.picture.path"
                         class="card-img-top mb-1" style="max-width: 219px"/>
                  </a>
                  <div class="stamp">
                    <!-- <img class="" src="https://educadorafm.ba.gov.br/logo.png" width="100%"> -->
                  ...
                  <div class="stamp-program" v-if=" artist.multicultura.id != idPlay "
                       @click="playMP3('https://ingest.educadorafm.ba.gov.br/'+artist.multicultura.mp3_upload.url,
                                artist.multicultura.id,
                                'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.multicultura.picture.path,
                                artist.trabalho,
                                'Multicultura',
                                artist.name,
                                `/selo/artista/${artist.id}`
                  ...
                  <div class="stamp-program" v-if="artist.multicultura.id == idPlay " @click="pauseMP3(artist.id)">
                    <img class="img-fluid"
                         :src="`https://ingest.educadorafm.ba.gov.br/img/stamp-programs/pause/36.svg`">
                  </div>
                  <div class="card-body p-0">
                    <a style="text-decoration: none">
                      <h5 class="card-title ml-1" style="font-family: 'Poppins light', sans-serif; font-size: 13px">{{ artist.multicultura.thin_line }}</h5>
                    </a>
                  </div>
                </div>
              </vue-glide-slide>
            ...
            <div class="row list mb-3 d-none d-sm-flex">
              ...
              <div class="col-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-2">
                <div class="card" style="background-color: #383838; max-width: 219px">
                  ...
                  <div class="stamp-program" v-if=" artist.multicultura.id != idPlay "
                       @click="playMP3('https://ingest.educadorafm.ba.gov.br/'+artist.multicultura.mp3_upload.url, artist.multicultura.id,
                                'https://ingest.educadorafm.ba.gov.br/thumbnail/'+ artist.picture.path,
                                artist.trabalho,
                                'Multicultura',
                                artist.name,
...
export default {
  ...
  mounted () {
    ...
    axios.get(`https://ingest.educadorafm.ba.gov.br/api/getSeloArtist/${id}`, {headers})
      .then(response => {
