        ...
        <div class="col-12 list px-4 pt-0 d-block d-sm-none">
          ...
          <div class="collapse custom-collapse" id="collapseExample">
            ...
            <div class="ml-1" style="color: white; font-family: 'Poppins', sans-serif">
              <div class="dropdown ml-1 mt-2" @click="ingestInfoSharedInternas">
                ...
                <ul class="dropdown-menu">
                  <ShareNetwork class="p-4" style="text-align: center"
                                ...
                                :key="network.network"
                                url="https://educadorafm.ba.gov.br/festival"
                                title="Conheça o Festival de Música Educadora FM"
                                description="Venha ouvir os vencedores de todas as edições do maior festival de música da Bahia, Festival de Música Educadora FM. *Baixe agora o novo App da Educadora FM 107.5* - Android: rebrand.ly/educadorafmandroid | iOS: rebrand.ly/educadorafmios"
              ...
              <div v-html="program.description" style="font-family: 'Poppins Medium', sans-serif; font-size: 14px">{{ program.description }}</div>
            </div>
            <hr style="width: 100%; border-top: 3px solid #fff;" />
          </div>
        </div>
              ...
              <div class="col-6 col-sm-3 col-lg-3 col-xxl-2" v-for="edition in editions" :key="edition.id">
                <div class="card">
                  ...
                  <div class="card-body p-0 mb-2" style="max-width: 219px; max-height: 219px">
                    <!-- <h5 class="card-line" style="font-family: 'Poppins light', sans-serif; font-size: 13px"><TruncateTextHelperComponent :max-caracteres="65" :texto-completo="`${edition.thin_line}`" /></h5> -->
                    <router-link
                      :to="{ name: 'festival_edition_detail', params: { id_edition: edition.id }}">
...
export default {
  ...
  metaInfo () {
    return {
      title: 'Festival de Música Educadora FM',
      titleTemplate: '%s | Educadora FM 107.5',
      meta: [
        {name: 'description', content: 'Venha ouvir os vencedores de todas as edições do maior festival de música da Bahia, Festival de Música Educadora FM.'},
        {property: 'og:title', content: 'Festival de Música Educadora FM | Educadora FM 107.5'},
        {property: 'og:description', content: 'Venha ouvir os vencedores de todas as edições do maior festival de música da Bahia, Festival de Música Educadora FM.'},
        {property: 'og:url', content: 'https://educadorafm.ba.gov.br/festival'},
        {property: 'twitter:title', content: 'Festival de Música Educadora FM | Educadora FM 107.5'},
        {property: 'twitter:description', content: 'Venha ouvir os vencedores de todas as edições do maior festival de música da Bahia, Festival de Música Educadora FM.'},
        {property: 'twitter:card', content: 'summary'},
        {property: 'twitter:url', content: 'https://educadorafm.ba.gov.br/festival'}
      ]
    }
  },
  ...
  mounted () {
    ...
    axios.get(`https://ingest.educadorafm.ba.gov.br/api/getFestival`, {headers})
      .then(response => {
  ...
  methods: {
    ...
    ingestInfoSharedInternas () {
      ...
      // console.log(this.program)
       axios.post('https://ingest.educadorafm.ba.gov.br/api/ingestInfo', requestData)
        .then(response => {
