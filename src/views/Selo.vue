        ...
        <div class="col-12 list px-4 pt-0 d-block d-md-none">
          ...
          <div class="collapse custom-collapse" id="collapseExample">
            <div class="card pt-2">
              ...
              <!--
              <div id="play-archive-chamada" class="btn-play" data-id="chamada" v-if="selo.spot">
                <button id="play" class="d-flex justify-content-center align-items-center" data-name="" data-img=""
                        data-id="chamada" data-url="" data-program="Chamada"
                        style="border-radius: 50%; background-color: rgba(246, 19, 19, 0.8); border: none; width: 40px; height: 40px; padding: 0; font-size: 16px; color: #fff">
                  <i class="fas fa-play"></i>
                </button>
              </div>
              <div id="play-archive-pause-chamada" data-id="chamada" class="btn-play" style="display: none">
                <button id="pause" class="d-flex justify-content-center align-items-center" data-id="chamada"
                        style="border-radius: 50%; background-color: rgba(246, 19, 19, 0.8); border: none; width: 40px; height: 40px; padding: 0; font-size: 16px; color: #fff;">
          ...
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <div class="row align-content-lg-between" style="border-bottom: 1px solid #fff">
              ...
              <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <div class="ml-1" style="color: white; font-family: 'Poppins', sans-serif">
                    <div class="compartilhar mt-2 pl-6 " style="color: white; margin-left: 20px;">
                      <a @click="share">
  ...
  methods: {
    async loadEditions () {
      try {
        ...
        axios.get(`https://ingest.educadorafm.ba.gov.br/api/getSeloIndex`, {headers})
          .then(response => {
